    ...
    <div class="twbb-image-gen-container">
        <div class="twbb-image-gen-topbar">
            <div class="twbb-image-gen-topbar-logo">
                <img src="<?php echo ((defined('TENWEB_WHITE_LABEL') && TENWEB_WHITE_LABEL) ? esc_url( \Tenweb_Builder\Modules\Helper::get_white_labeled_icon()) : esc_url( TWBB_URL . '/Apps/ImageGenerationAI/assets/images/10Web_logo.svg'));?>">
                <hr>
            </div>
