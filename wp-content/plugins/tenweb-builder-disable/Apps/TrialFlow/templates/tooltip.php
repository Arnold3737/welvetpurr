        ...
        <div class="twbb-tf-element">
            <div class="twbb-tf-element__left">
                ...
                <div class="twbb-tf-element__days twbb-tf-element__item">
                    <div><span class="days-left"><?php esc_html_e('3 days', 'tenweb-builder');?></span> <?php esc_html_e('left in trial', 'tenweb-builder');?></div>
        ...
        <div class="twbb-tf-tooltip">
            <div class="twbb-tf-tooltip__content">
                <div class="twbb-tf-tooltip__days">
                    ...
                    <div class="twbb-tf-tooltip__days-sub-title ht"><span>3</span> <?php esc_html_e(' days for free', 'tenweb-builder');?></div>
                    ...
                    <div class="progress-container">
                        ...
                        <div class="step-circle-container" data-top="33">
                            ...
                            <div class="step-content">
                                ...
                                <span class="step-description">You’ve unlocked 3 days of full access</span>
                            </div>
                        </div>
...
<div id="trial-container" class="trial-upgrade-container">
    <div class="twbb-unlock-container">
        <h1 class="twbb-unlock-title"><?php esc_html_e("You have unlocked 3-day free trial.","tenweb-builder"); ?></h1>
        ...
        <div class="twbb-timeline-steps">
            ...
            <div class="twbb-timeline-step">
                ...
                <div class="step-content">
                    ...
                    <p class="step-description"><?php esc_html_e("You’ve unlocked 3 days of full access","tenweb-builder"); ?></p>
                </div>
            </div>
