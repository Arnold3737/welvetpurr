...
class Manager
{
    ...
    public function register_hooks()
    {
        ...
        if ($this->user_logged_in && is_admin()) {
	        ...
	        $this->trial_flow = ( Helper::check_if_manager_mu() && is_array($user_info['agreement_info']) && isset($user_info['agreement_info']['subscription_id']) && $user_info['agreement_info']['subscription_id'] === $platform_id );
	        if ( $this->trial_flow ) {
